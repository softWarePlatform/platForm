...
| 编号 | 类型 | 文件 |
| --- | --- | --- |
| DES-COMP-001 | 总体组件图 | `figures/总体组件图.jpg` |
| DES-SD-UC01 … UC10 | 组件级顺序图 | `figures/组件级/UCxx 组件级.jpg` |
| DES-ST-UC01/05/06/07 | 状态图 | `figures/活动图/UC01.svg` 等 |
...
每个用例用到的组件子集见 [02-各用例组件图.md](./02-各用例组件图.md)（`DES-COMP-UC01` … `UC10`）。
...
![DES-ST-UC01 选课状态图](./figures/活动图/UC01.svg)

未选 / 已选 / 候补；退课空位可晋升候补。

### 9.2 DES-AD-UC02 课程发布活动

![DES-AD-UC02 课程发布活动图](./figures/活动图/UC02.svg)

### 9.3 DES-AD-UC03 公告已读活动

![DES-AD-UC03 公告已读活动图](./figures/活动图/UC03.svg)

### 9.4 DES-AD-UC04 资料访问活动

![DES-AD-UC04 资料访问活动图](./figures/活动图/UC04.svg)

### 9.5 DES-ST-UC05 作业提交状态

![DES-ST-UC05 作业状态图](./figures/活动图/UC05.svg)

展示态由 `homework-student.ts` 根据 `locked`、`submittedAt`、`graded`、`returnReason`、`released` 推导。

### 9.6 DES-ST-UC06 实验提交状态

![DES-ST-UC06 实验提交状态图](./figures/活动图/UC06.svg)
...
![DES-ST-UC07 练习会话状态图](./figures/活动图/UC07.svg)

提交即批改完成，`GRADED` 为终态。

### 9.8 DES-AD-UC08 讨论与通知活动

![DES-AD-UC08 讨论通知活动图](./figures/活动图/UC08.svg)

### 9.9 DES-AD-UC09 成绩汇总活动

![DES-AD-UC09 成绩汇总活动图](./figures/活动图/UC09.svg)

### 9.10 DES-AD-UC10 管理配置活动

![DES-AD-UC10 管理配置活动图](./figures/活动图/UC10.svg)
...
| 类别 | 路径 | 本文使用 | 说明 |
| --- | --- | --- | --- |
| 总体组件图 | `figures/总体组件图.jpg` | DES-COMP-001 | UML 组件图，虚线依赖 |
...
| 系统级 | `figures/系统级/` | 不嵌入正文 | UC06—UC08，对照角色 A |
| 对象级 | `figures/对象级/` | 不嵌入正文 | UC06—UC08，对照角色 C |
