...
负责人：吴本昭  
范围：UC06 实验评测、UC07 练习、UC08 讨论通知；D4–D5 另承担全项目概要设计（角色 B）

**交件入口：[最终提交/](./最终提交/)**（概要设计说明书 + 全部图）

按日查阅工作底稿。D1 的缺口与验证命令已并入 D3。

| 日期 | 阶段 | 目录 | 当日交付 |
| --- | --- | --- | --- |
| 2026-08-25 | D1 基线验证 | [2026-8-25](./2026-8-25/) | Redis/Worker 启动；UC06—UC08 首次跑通；域表接口清单 |
| 2026-08-26 | D2 需求说明 | [2026-8-26](./2026-8-26/) | 三份用例说明；三级图已归档到 8.28 `figures/` |
| 2026-08-27 | D3 自动回归 | [2026-8-27](./2026-8-27/) | `npm run test:lab` / `test:lab:unit`；缺口关闭记录 |
| 2026-08-28 | D4 概要设计 | [2026-8-28](./2026-8-28/) | 说明书起草；图按类别归档 |
| 2026-08-29 | D5 交件定稿 | [2026-8-29](./2026-8-29/) · **[最终提交](./最终提交/)** | 说明书 V2.1 + 21 张必交图 |
...
| `figures/` | 原图已迁走，见 [2026-8-28/figures](./2026-8-28/figures/) |
...
### D4（8.28）`docs/吴本昭/2026-8-28/`

| 文件 | 内容 |
| --- | --- |
| `01-概要设计说明书.md` | 定稿 V2.0，正文嵌入已导出图 |
| `02-各用例组件图.md` | 每用例 1 张组件图 DES-COMP-UC01…UC10 |
| `figures/总体组件图.jpg` | DES-COMP-001 |
| `figures/组件级/` | UC01—UC10 组件级顺序图 jpg |
| `figures/活动图/` | UC01—UC10 状态图/活动图 svg |
| `figures/系统级/` | UC06、UC07、UC08 系统级 jpg |
| `figures/对象级/` | UC06、UC07、UC08 对象级 jpg |

### D5（8.29）`docs/吴本昭/2026-8-29/`

| 文件 | 内容 |
| --- | --- |
| `00-D5-当日工作简报.md` | 站会简报 |
| 最终交件 | 见 [最终提交/](./最终提交/) |